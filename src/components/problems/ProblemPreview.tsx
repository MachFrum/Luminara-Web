...
export const ProblemPreview: React.FC<ProblemPreviewProps> = ({ problem, onClick }) => {
  return (
    <div onClick={() => onClick(problem)} className="bg-light-surface/30 dark:bg-dark-surface/30 backdrop-blur-xl p-4 sm:p-5 rounded-[24px] shadow-md hover:shadow-lg cursor-pointer hover:scale-[1.02] transition-all duration-300 ease-in-out relative overflow-hidden border-[1.5px] border-[#d9c4b0]">
